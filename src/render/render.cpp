  ...
  pcl::visualization::PCLVisualizer::Ptr& viewer)
{
  ...
  viewer->addCube(
    roadLengthBehind, roadLengthAhead, -roadWidth / 2, roadWidth / 2, -roadHeight, 0, .2, .2, .2, "highwayPavement");
  ...
  while (markerPos <= roadLengthAhead) {
    ...
    viewer->addCube(
      ...
      poleWidth/2  + roadWidth/2 + poleCurve,
      0, poleHeight, 1, 0.5, 0, "pole_" + std::to_string(poleIndex) + "l");
    ...
    viewer->addCube(
      ...
      -poleWidth/2 + roadWidth/2 + poleCurve,
      poleWidth/2  + roadWidth/2 + poleCurve,
      0, poleHeight, 0, 0, 0, "pole_" + std::to_string(poleIndex) + "lframe");
    ...
    viewer->addCube(
      ...
      -poleWidth/2 - roadWidth/2 - poleCurve,
      poleWidth/2  - roadWidth/2 - poleCurve,
      0, poleHeight, 1, 0.5, 0, "pole_" + std::to_string(poleIndex) + "r");
    ...
    viewer->addCube(
      ...
      -poleWidth/2 - roadWidth/2 - poleCurve,
      poleWidth/2  - roadWidth/2 - poleCurve,
      0, poleHeight, 0, 0, 0, "pole_" + std::to_string(poleIndex) + "rframe");
  ...
  float                                   opacity)
{
  ...
  viewer->addCube(
    box.x_min, box.x_max, box.y_min, box.y_max, box.z_min, box.z_max, color.r, color.g, color.b, cube);
